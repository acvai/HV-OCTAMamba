...
class H_SS2D(nn.Module):
    ...
    def forward(self, x, mask=None, dummy=False):
        ...
        if C != self.proj_in.in_channels:
            raise ValueError(f"Expected input to have {self.proj_in.in_channels} channels, but got {C} channels instead.")
...
# go to : (octamamba) imvia@imvia70:/mnt/c/Users/Amine/Projects/H-vmunet-main$ 
# run script: python -m models.H_vmunet

if __name__ == '__main__':
    module = H_SS2D(dim=16, order=3)
